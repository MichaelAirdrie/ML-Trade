...
class OAuth2Client extends authclient_1.AuthClient {
    ...
    async verifySignedJwtWithCertsAsync(jwt, certs, requiredAudience, issuers, maxExpiry) {
        ...
        const segments = jwt.id_token.split('.');
        //const segments = jwt.split('.'); this is what the code used to be but jwt was being passed in as a fucking json. This change was made by Michael Airdrie
